  ...
  try {
    ...
    const messages: Messages = [
      ...
      },
      {
        role: "user",
        content:
          "The format for each flashcard should be an array of objects with 'question' and 'answer' fields. e.g. [{ question: 'What is X?', answer: 'X is ...' }, { question: 'What is Y?', answer: 'Y is ...' }]"
      },
      {
        role: "user",
        content:
          "Just return the flashcards in JSON format without any additional text or explanation. And make sure to generate exactly " +
          count +
          " flashcards. If you cannot generate that many, return as many as you can. Also, given to your process limit, just use the most effective and important information from the document to create the flashcards to ensure faster and correct responses."
      }
    ];
